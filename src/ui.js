...
export function renderHeroShop() {
  ...
  for (const hero of state.heroes) {
    ...
    if (owned) {
      ...
      amountSpan.textContent = `${cfg.price} pièces`;
    ...
    btn.textContent = equipped ? "Équipé" : owned ? "Équiper" : "Acheter";
...
export function buildQuestionUiHooks() {
  ...
  return {
    onOpenQuestion(question, uiMeta = null) {
      ...
      ui.questionPrompt.append(
        "Conjugue ",
        Object.assign(document.createElement("span"), { className: "verb", textContent: inf }),
        ` ${tenseText}`,
        document.createElement("br"),
        Object.assign(document.createElement("span"), { className: "pronoun", textContent: pronoun }),
        " ",
        Object.assign(document.createElement("span"), { className: "blank", textContent: "???" }),
      );
