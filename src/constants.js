...
export function getHeroShopConfig(heroId) {
  return HERO_SHOP_CONFIG[heroId] || { price: 19998, order: 99, defaultOwned: false };
}
...
export const MOBILE_BUTTONS_OFFSET_STORAGE_KEY = "cquest_mobile_buttons_offset_v2";
export const MOBILE_GAME_OFFSET_STORAGE_KEY = "cquest_mobile_game_offset_v2";
